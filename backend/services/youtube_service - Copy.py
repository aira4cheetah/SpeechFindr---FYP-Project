...
class YouTubeService:
    ...
    async def fetch_and_extract_audio(self, url: str, video_id: str) -> dict:
        ...
        # Add common browser headers and network options to reduce 403s from YouTube
        ydl_opts = {
            ...
            # Helpful for avoiding 403 Forbidden errors
            'http_headers': {
                'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/117.0.0.0 Safari/537.36',
                'Referer': 'https://www.youtube.com/'
            },
            'geo_bypass': True,
            'source_address': '0.0.0.0',  # prefer IPv4; change if needed
            'socket_timeout': 15,
        }
